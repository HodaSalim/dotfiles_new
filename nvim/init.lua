...
require('lazy').setup({
  ...
  {
    'tpope/vim-rails',
    ft = { 'ruby', 'eruby', 'haml', 'slim' }, -- Load only for Ruby files
    dependencies = { 'tpope/vim-bundler' }, -- Optional but recommended dependency
  },
  ...
  require 'kickstart.plugins.gitsigns', -- adds gitsigns recommend keymaps
  {
    'stevearc/oil.nvim',
    opts = {
      -- Oil.nvim configuration options
      ...
      -- If you want to replace netrw completely:
      view_options = {
        show_hidden = true,
      },
      -- Oil.nvim uses vim.keymap.set to map in the buffer
      keymaps = {
        ['g?'] = 'actions.show_help',
        ['<CR>'] = 'actions.select',
    ...
    end, { desc = 'Toggle Oil file explorer in float window' }),
  },
